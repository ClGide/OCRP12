# Generated by Django 4.0.6 on 2022-07-22 09:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_status', models.PositiveSmallIntegerField(choices=[(1, 'potential'), (2, 'existent with at least one upcoming event.'), (3, 'existent with at least one past event.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'manage team'), (2, 'sales team'), (3, 'support team')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.BooleanField(blank=True, default=False, help_text='If True, the event just took place')),
                ...
                ('date_updated', models.DateTimeField(auto_now_add=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRM.client')),
                ('contract', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='CRM.contract')),
